...
#ifndef LINUX_CROSS_COMPILE
  # include definitions for the BA2 architecture
  include $(SDK_BASE_DIR)/Chip/Common/Build/config_ba2.mk
#else
#  # include definitions for the OR32 architecture
#  include $(SDK_BASE_DIR)/Chip/Common/Build/config_or32.mk
#endif
...
ifeq ($(TOS_COMPILE), TRUE)
LINKER_FILE = AppBuildTinyos
else
