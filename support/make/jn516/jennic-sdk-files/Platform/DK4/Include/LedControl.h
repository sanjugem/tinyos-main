...
#if (defined PCB_DK2) || (defined JENNIC_PCB_DEVKIT2)
...
#define LED_CTRL_MASK   (LED_S0_PIN | LED_S1_PIN | LED_S2_PIN)

PUBLIC void vLedControl(uint8 LED, uint8 ON);
							  				
#define vLedInitFfd() \
            vAHI_DioSetDirection(0, LED_CTRL_MASK)

#define vLedInitRfd() vLedInitFfd()
#endif
