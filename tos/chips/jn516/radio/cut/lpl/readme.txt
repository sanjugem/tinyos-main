...
Jn516 stack there is implemented to define a low-level abstraction layer
...
Other low power listening layers can be implemented as well:
  * Continuous modulation / No Acknowledgements:
     > Allows the receiver to achieve the lowest possible receive check
       ...
       and the Jn516 can acheive it by putting some transmit register into
       ...
       be calculated by the Jn516.  Not sure if the preamble and sync bytes
