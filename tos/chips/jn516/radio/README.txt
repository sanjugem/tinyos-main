...
To remove all acknowledgements, #define (or use Jn516Config in 2.0.2)
  Jn516_NO_ACKNOWLEDGEMENTS
  
To use hardware auto-acks instead of software acks, #define:
  Jn516_HW_ACKNOWLEDGEMENTS

To stop using address recognition on the radio hardware, #define:
  Jn516_NO_ADDRESS_RECOGNITION



============================================================
Jn516 2.0.2 Release Notes 7/2/07

Updates (Moss)
__________________________________________
* New chip SPI bus arbitration working with Receive and Transmit.

* Applied TUnit automated unit testing to Jn516 development
  > Caught lots of bugs, especially through regression testing
  > Source code in tinyos-2.x-contribs/tunit/

* Applied TEP115 behavior to Jn516 SplitControl in Csma and Lpl

* Updated ActiveMessageAddressC to provide the ActiveMessageAddress interface
  > Updated Jn516ConfigP to handle ActiveMessageAddress.addressChanged() and
    sync automatically upon address change events.

* Updated Jn516Config interface to enable/disable sw/hw acknowledgements

* Updated Jn516ConfigP to share register editing through single functions
...
* Moved the getHeader() and getMetadata() commands to an internal interface
  called Jn516PacketBody, provided by Jn516PacketC
...
* Added two methods to enable/disable automatic address recognition:
  - Preprocessor Jn516_NO_ADDRESS_RECOGNITION to disable address recognition at
    compile time
  - Jn516Config.setAddressRecognition(bool on) through Jn516ControlC

* Allowed the Jn516ReceiveP to perform software address checks to support
...
* Updated Jn516Config interface to provide an async getShortAddr() and getPanAddr()
...
============================================================
Jn516 Release Notes 4/11/07

This Jn516 stack contains two low power listening strategies,
